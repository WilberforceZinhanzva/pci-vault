...
public class VaultController {
    ...
    public UnEncryptedData deTokenize(@RequestParam String token,@RequestParam String passphrase) throws Exception {
        return vaultService.deTokenize(token,passphrase);
    }
}
